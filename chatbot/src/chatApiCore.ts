...
const cannedRules: CannedRule[] = [
  ...
  },
  {
    ...
    answer: () => `Hermes setups are packaged Desks: Starter Desk $500, Operator Desk $1,500, and Connected Desk $3,500. CRM plus books is Connected, not Starter. The free 30-minute introductory call classifies which Desk fits. ${introCallCta("what you want the agent to do, which tools it should use")}`
  },
  {
    ...
    answer: () => `No. Discovery and builds are custom work: dashboards, system integrations, reporting systems, workflow automation, and cleanup of tools you already have. A Hermes Desk is not required. Paid discovery ($2,000) maps the work first. The build after that is quoted, usually $4,500–15,000. A Desk is only used when it actually fits. ${introCallCta("the work you want fixed, the tools you already use")}`
  },
  {
  ...
  },
  {
    ...
    answer: () => `Great question! Pricing for CRM or sales-ops cleanup depends on the platform, data quality, number of workflows, automations, reporting needs, and how much process mapping is required. A quick HubSpot/Salesforce cleanup is different from rebuilding lead routing, pipeline visibility, dashboards, and team workflows. ${introCallCta("the CRM, pain points, desired outcome")}`
  },
  {
  ...
  },
  {
    ...
    answer: () => `Tutoring is $125 per hour, with a 90-minute minimum of $175. That is the only metered service. Larger “help me decide” work is paid discovery, not tutoring. ${introCallCta("what you want to learn or build, your current level")}`
  },
  {
    name: "pricing-ai",
  ...
  },
  {
    ...
    answer: () => `Dashboard and data jobs are quoted after paid discovery, not as a single number from this chat. Published builds sit in a $4,500–15,000 range once the work is scoped. The first step is a free 30-minute introductory call. ${introCallCta("your data sources, current reporting pain, desired metrics")}`
  },
  {
    name: "pricing-care",
  ...
  },
  {
    ...
    answer: () => `The best next step is a free 30-minute introductory call. Pick a time at https://calendly.com/josh-gemmi/30min.`
  },
  {
    name: "availability",
    test: (text) => hasAny(text, [/\b(available|availability|when can|timeline|start|taking clients|open to work|hire|hiring)\b/]),
    answer: () => `Yonatan is available for consulting, contract work, tutoring/coaching, technical troubleshooting, AI implementation, dashboards, ecommerce operations, CRM/workflow cleanup, and operator-builder engagements. Availability depends on the scope and timing. ${introCallCta("the project details, desired timeline")}`
  },
  {
    name: "resume",
  ...
  },
  {
    ...
    answer: () => `Yes — Yonatan offers tutoring, coaching, and hands-on project help. This can include learning AI tools, understanding automations, building dashboards, improving ecommerce workflows, troubleshooting technical issues, or getting guided help on a project. ${introCallCta("what you want to learn or build")}`
  },
  {
    name: "ecommerce",
  ...
  },
  {
    ...
    answer: () => `Yes — optimizing a stack of spreadsheets is a strong fit. A good first pass is usually to map which sheets feed which decisions, identify the source of truth, remove duplicate/manual entry, standardize the key fields, then turn the important outputs into a cleaner dashboard, reporting flow, or lightweight data platform. Helpful specifics are: how many spreadsheets there are, who updates them, what systems they come from, where mistakes happen, and what decisions the reporting needs to support. ${introCallCta("those details")}`
  },
  {
    name: "crm",
    test: (text) => hasAny(text, [/\b(crm|salesforce|hubspot|sales ops|pipeline management|lead routing|vendor)\b/]),
    answer: () => `Yes — CRM and sales-operations workflow cleanup may be a fit. Yonatan can help map the actual process, clean up Salesforce/HubSpot-style workflows, improve visibility, and connect CRM work to reporting or automation. ${introCallCta("the current CRM, pain points, desired outcome")}`
  },
  {
    name: "tech-ops",
    ...
    answer: () => `Yes — small-business technical operations and troubleshooting may be a fit. Yonatan has experience across workstation setup, network/process troubleshooting, MDM/mobile-device operations, diagnostics workflows, and practical implementation. ${introCallCta("the environment, the issue")}`
  },
  {
    name: "what-is-hermes",
    test: (text) => hasAny(text, [
  ...
  },
  {
    ...
    answer: () => `Yes — custom GPTs and GPT-style assistants are a strong fit. Yonatan has built major Custom GPT workflows and can help design the knowledge structure, instructions, workflows, actions/integrations, testing loop, and handoff so the assistant is actually useful in a real process. ${introCallCta("what the GPT should do, who will use it")}`
  },
  {
    name: "ai-general",
  ...
  },
  {
    ...
    answer: () => `Yes — backend, integration, and internal-tool work can be a fit when it connects to a real workflow or operational problem. Yonatan can help with APIs, databases, Cloud Run/Google Cloud-style deployments, data flows, dashboards, and practical internal tools. ${introCallCta("what needs to connect, what currently exists")}`
  },
  {
    name: "services",
...
Answer in 2-5 short sentences. Be helpful and direct. Never ask for private credentials or sensitive data. Always close by inviting a free 30-minute introductory call at https://calendly.com/josh-gemmi/30min. Do not ask them to send a note or email in order to schedule. Do not invent prices.`;
}
